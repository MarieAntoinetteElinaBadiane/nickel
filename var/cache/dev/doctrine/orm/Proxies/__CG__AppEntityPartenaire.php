...
class Partenaire extends \App\Entity\Partenaire implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'ninea', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'adresse', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'raison_sociale', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'photo', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'users', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'comptes'];
        }
     ...
     * {@inheritDoc}
     */
    public function setRaisonSociale(string $raison_sociale): \App\Entity\Partenaire
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRaisonSociale', [$raison_sociale]);

        return parent::setRaisonSociale($raison_sociale);
    }
     ...
     * {@inheritDoc}
     */
    public function setPhoto(string $photo): \App\Entity\Partenaire
    {
